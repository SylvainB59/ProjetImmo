...
class ViewUser{
	...
	public static function connectUser(){
		...
		<div>
			...
			<hr>
			<a href="userResetMdp.php" class="btn btn-warning">mdp oublié</a>
		</div>
		<?php
	}

	public static function testUserMail(){
		isset($_POST['confirmTestUserMail']) ? $formSubmit = true : $formSubmit = false;
		?>
		<div>
			<div id="erreurs"></div>
			<form name="testUserMail" id="testUserMail" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post" target="_self"  enctype="multipart/form-data">
				<div class="form-group">
					<label for="mail">mail</label>
					<input type="email" class="form-control" id="mail" name="mail" value="<?php echo $formSubmit?$_POST['mail']:''; ?>">
				</div>
				<!-- <div class="form-group"> -->
			  		<button type="submit" name="confirmTestUserMail" class="btn btn-primary">valider</button>
			  		<!-- <button type="reset" name="annuler" class="btn btn-danger">Annuler</button> -->
			  	<!-- </div> -->
			</form>
		</div>
	...
	public static function resetMdp($mail){
		isset($_POST['confirmResetMdp']) ? $formSubmit = true : $formSubmit = false;
		?>
		<div>
			<div id="erreurs"></div>
			<form name="resetMdp" id="resetMdp" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post" target="_self"  enctype="multipart/form-data">
				<input type="hidden" class="form-control" id="mail" name="mail" value="<?php echo $mail; ?>">
				<div class="form-group">
					<label for="pass">mot de pass</label>
	                <input type="password" name="pass" id="pass" class="form-control" aria-describedby="pass" placeholder="mot de passe" required>
	            </div>
				...
				<!-- <div class="form-group"> -->
			  		<button type="submit" name="confirmResetMdp" class="btn btn-primary">valider</button>
			  		<!-- <button type="reset" name="annuler" class="btn btn-danger">Annuler</button> -->
			  	<!-- </div> -->
			</form>
		</div>
